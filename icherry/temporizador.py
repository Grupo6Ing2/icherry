...
class Temporizador :
    ...
    def _ejecutarCada(self,segundos,funcion,args) :
        self.timer = threading.Timer(segundos,self._action,[segundos,funcion,args])
...
def demo() :
    ...
    t4.ejecutarCada(DuracionEnSegundos(12), detener, [temporizadores,contador])
    ...
    for t in temporizadores : t.iniciarEjecucion()
